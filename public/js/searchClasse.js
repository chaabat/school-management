                ...
                data.forEach(function(subjectData) {
                    ...
                    <div class="bg-white py-4 px-3" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('photos/classe2.jpg') no-repeat center; background-size: cover;">
                            ...
                            <div class="flex justify-between">
                                <a href="/classes/${subjectData.id}/edit">
                                    <img src="/photos/update.png" class="h-6" alt="">
                                </a>
                                <a href="#" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this subject?')) { document.getElementById('delete-form-${subjectData.id}').submit(); }"><img src="/photos/delete.png" class="h-6" alt=""></a>
                                <form id="delete-form-${subjectData.id}" action="/classes/${subjectData.id}" method="POST" style="display: none;">
