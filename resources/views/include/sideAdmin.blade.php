    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-[#03045e] dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('teachers.index') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{asset('photos/teacher.png')}}" class="h-6 " alt="">
            ...
            <li>
                <a href="{{ route('students.index') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{asset('photos/students.png')}}" class="h-6 " alt="">
            ...
            <li>
                <a href="{{ route('parents.index') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{asset('photos/parents.png')}}" class="h-6 " alt="">
        ...
        <li>
            <a href="{{ route('subjects.index') }}"
                class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                <img src="{{asset('photos/bibliotheque.png')}}" class="h-6 " alt="">
        ...
        <li>
            <li>
                <a href="{{ route('exams.index') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{asset('photos/tester.png')}}" class="h-6 " alt="">

                    <span class="flex-1 ms-3 whitespace-nowrap">Exams</span>
                </a>
            </li>
            <a href="{{route('subject-to-class.index')}}"
                class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                <img src="{{asset('photos/subjectToClass.png')}}" class="h-6 " alt="">
                
                <span class="flex-1 ms-3 whitespace-nowrap">Assign subject to class</span>
            </a>
        </li>
        <li>
            <a href="{{route('teacher-to-class.index')}}"
                class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                <img src="{{asset('photos/teacherToClass.png')}}" class="h-6 " alt="">

                <span class="flex-1 ms-3 whitespace-nowrap">Assign teacher to class</span>
            </a>
        </li>
        <li>
