                ...
                <div class="relative p-2 w-full max-w-2xl h-full md:h-auto">
                    ...
                    <div class="relative p-4   bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <form action="{{ route('create.subject') }}" method="post">
                            ...
                            <button type="submit"
                                class="text-white inline-flex items-center bg-blue-900   focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
