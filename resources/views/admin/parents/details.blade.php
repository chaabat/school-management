                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul class="mt-2 text-gray-700">
                            ...
                            <li class="flex border-b py-2">
                                ...
                                <span class="text-gray-700">{{ $parent->adress }}</span>
                            </li>
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Ville:</span>
                                <span class="text-gray-700">{{ $parent->ville }}</span>
                            </li>
                            <li class="flex border-b py-2">
                            ...
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Student:</span>
                                <span class="text-blue hover:text-orange font-mono font-bold underline">
                                    <a href="{{ route('myStudent', $parent->id) }}">Details </a></span>
