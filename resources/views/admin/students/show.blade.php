...
<div class="p-4  rounded-lg  mt-14">
    <h2 class="flex items-center justify-center mb-4 mt-4 text-3xl font-bold font-mono text-white">Students
    </h2>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex space-x-4 items-right">
                                        ...
                                        <a href="{{route('update.student')}}"><img src="{{ asset('photos/update.png') }}" class="h-6" alt=""></a>
