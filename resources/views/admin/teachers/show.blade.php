...
@section('teacher')
    <div class="p-4 h-screen sm:ml-64"
        ...
        <div class="p-4  rounded-lg  mt-14">
            <h2 class="flex items-center justify-center mb-4 mt-4 text-3xl font-bold font-mono text-white">Teachers
            </h2>
                        ...
                        <div
                            ...
                            <div class="w-72 md:w-1/2">
                                <form class="flex items-center">
                                    ...
                                    <button
                                        class="ml-2 flex items-center justify-center text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Search</button>
                                </form>
                            </div>

                            <div
                                class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                <a href="{{ route('add.teacher') }}"><button type="button"
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex space-x-4 items-right">
                                                <a href=""><img src="{{ asset('photos/show.png') }}" class="h-6" alt=""></a>
                                                <a href="{{route('update.teacher')}}"><img src="{{ asset('photos/update.png') }}" class="h-6" alt=""></a>
                                                <a href=""><img src="{{ asset('photos/delete.png') }}" class="h-6" alt=""></a>
