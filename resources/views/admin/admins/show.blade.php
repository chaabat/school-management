...
@section('admin')
    <div class="p-4 h-screen sm:ml-64"
        ...
        <div class="p-4  rounded-lg  mt-14">
            <h2 class="flex items-center justify-center mb-4 mt-4 text-3xl font-bold font-mono text-white">Admins List
            </h2>
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select id="genre" name="genre"
                                        ...
                                        <option disabled selected="">Select Votre Genre</option>
